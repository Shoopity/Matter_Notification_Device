...
// Define Seeed C6 LED pin here
#define SEEED_C6_LED_GPIO GPIO_NUM_15
...
static esp_err_t app_driver_light_set_power(led_driver_handle_t handle,
...
static esp_err_t app_driver_light_set_brightness(led_driver_handle_t handle,
                                                 esp_matter_attr_val_t *val) {
  int value =
      REMAP_TO_RANGE(val->val.u8, MATTER_BRIGHTNESS, STANDARD_BRIGHTNESS);
  return led_driver_set_brightness(handle, value);
}

static esp_err_t app_driver_light_set_hue(led_driver_handle_t handle,
                                          esp_matter_attr_val_t *val) {
  int value = REMAP_TO_RANGE(val->val.u8, MATTER_HUE, STANDARD_HUE);
  return led_driver_set_hue(handle, value);
}

static esp_err_t app_driver_light_set_saturation(led_driver_handle_t handle,
                                                 esp_matter_attr_val_t *val) {
  int value =
      REMAP_TO_RANGE(val->val.u8, MATTER_SATURATION, STANDARD_SATURATION);
  return led_driver_set_saturation(handle, value);
}

static esp_err_t app_driver_light_set_temperature(led_driver_handle_t handle,
                                                  esp_matter_attr_val_t *val) {
  uint32_t value =
...
static esp_err_t app_driver_light_set_xy(led_driver_handle_t handle, uint16_t x,
                                         uint16_t y) {
...
static void app_driver_button_toggle_cb(void *arg, void *data) {
  ...
  attribute_t *attribute =
      attribute::get(endpoint_id, cluster_id, attribute_id);
...
esp_err_t app_driver_light_set_defaults(uint16_t endpoint_id) {
  ...
  /* Setting brightness */
  attribute_t *attribute =
      attribute::get(endpoint_id, LevelControl::Id,
  ...
  if (val.val.u8 ==
    ...
    /* Setting temperature */
    attribute =
        attribute::get(endpoint_id, ColorControl::Id,
                       ColorControl::Attributes::ColorTemperatureMireds::Id);
    attribute::get_val(attribute, &val);
    err |= app_driver_light_set_temperature(handle, &val);
  } else if (val.val.u8 ==
...
app_driver_handle_t app_driver_light_init() {
  ...
  /* Override with specific Seeed C6 LED pin */
  config.gpio = 15;
  /* Initialize the physical LED and return the handle */
