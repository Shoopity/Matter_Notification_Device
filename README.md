...
3. Set the active folder/project to either `generic_switch` or `light`.
...
Follow these steps for **each** project (`generic_switch` and `light`):
1. Navigate to the project directory:
   ```bash
   cd generic_switch   # Or cd light
   ```
